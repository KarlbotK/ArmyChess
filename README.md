...
- 每位玩家自动旋转为“自己在下方”的视角；
- 合法落点、工兵可达铁路网与具体行进路线、战斗、投降、聊天与刷新重连；
...
浏览器打开 `http://127.0.0.1:4173/`。纯界面演示可打开 `http://127.0.0.1:4173/?demo=1`；工兵路线、夺旗文案和无棋可走文案的固定验收场景分别使用 `scenario=sapper-route`、`scenario=flag-capture`、`scenario=no-legal-move`。
