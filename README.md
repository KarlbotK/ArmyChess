...
浏览器打开 `http://127.0.0.1:4173/`。纯界面演示可打开 `http://127.0.0.1:4173/?demo=1`。
...
默认从 `http://localhost:8088` 访问。正式上线前需要设置真实域名、HTTPS/WSS、监控告警、隐私条款，并由仓库所有者选择开源许可证。
